...
Below we construct two regression models to predict the number of days
in a month an individual reported having good physical health
(`healthy_days`).
...
method. For the purposes of this analysis, we will use the 10-fold cross
validation method.
...
itself, which will be used to implement our algorithms.
...
Best lambda and best alpha are \_\_\_\_\_\_\_.
